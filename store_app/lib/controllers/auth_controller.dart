...
import '../views/auth_screens/main_screen.dart';
...
class AuthController {
  ...
  Future<void> signUpUsers(
    ...
    try {
      final user = User(
          ...
          password: password,
          token: '');
      final response = await http.post(Uri.parse('$uri$signUpUri'),
  ...
  Future<void> signInUsers(
      {required context,
        ...
        required String password}) async {
    try {
      final response = await http.post(Uri.parse('$uri$signInUri'),
